export const SERVICES = [
  {
    ...
    icon: 'Globe',
    features: ['SSR/SSG', 'PWA', 'E-commerce', 'CMS Integration']
  },
  {
    title: 'Mobile Apps',
  ...
  },
  {
    ...
    icon: 'Brain',
    features: ['Computer Vision', 'NLP', 'Predictive Analytics', 'Automation']
  },
  {
    title: 'Data Analytics',
    description: 'Data-driven insights and visualization dashboards.',
    icon: 'BarChart',
    features: ['Big Data', 'Real-time Analytics', 'Dashboards', 'ETL']
  },
  {
    title: 'UI/UX Design',
